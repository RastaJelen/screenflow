    ...
    <div className="space-y-8">
      <div className="grid lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="space-y-6">
          <div>
            <h2 className="text-2xl font-bold text-slate-800 mb-2">Question 3</h2>
            <p className="text-xl text-slate-700 mb-6">Does the functions need to be changed?</p>
          </div>
          ...
          {showFunctionQuestions && (
            <Card className="bg-white shadow-md border border-slate-200">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-slate-800 mb-3">FUNCTION QUESTIONS</h3>
                <p className="text-slate-600 mb-6">Detailed functionality testing questions will be implemented here</p>
                <div className="bg-slate-100 p-4 rounded-lg mb-6">
                  <p className="text-sm text-slate-500">
                    Future implementation: Function-specific testing criteria and evaluation questions
                  </p>
                </div>
                <Button 
